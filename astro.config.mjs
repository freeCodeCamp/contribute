      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Use the Curriculum Helpers', link: 'curriculum-help' },
            {
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'User Token Workflow', link: 'user-token-workflow' },
            {
        ...
        },
        {
          ...
          items: [
            { label: 'Moderator Handbook', link: 'moderator-handbook' },
            { label: 'Reply Templates', link: 'reply-templates' },
            {
              label: 'Language Lead Handbook',
              link: 'language-lead-handbook'
            },
            { label: 'DevOps Handbook', link: 'devops' },
            {
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Chat Server', link: 'https://discord.gg/PRyKn3Vbay' }
          ]
        }
      ]
    })
