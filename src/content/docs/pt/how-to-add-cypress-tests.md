---
title: Como adicionar testes Cypress
---
...
> [!NOTE] Se estiver usando Gitpod, veja essa [configuração sobre Cypress-Gitpod](how-to-add-cypress-tests#cypress-gitpod-setup)
...
Agora, [o Cypress pode ser executado](how-to-add-cypress-tests#_2-run-the-cypress-tests)
