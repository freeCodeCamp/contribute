...
Para ver como o client é renderizado em outro idioma, acesse [teste da aplicação do client em um idioma mundial.](how-to-work-on-localized-client-webapp#Testing-the-Client-App-in-a-World-Language)
