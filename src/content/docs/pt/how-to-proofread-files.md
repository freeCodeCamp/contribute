---
title: Como revisar as traduções
---
...
> [!NOTE] Se você estiver nesta visão de espaço de trabalho, mas quiser [traduzir um arquivo](how-to-translate-files) em vez de revisar, você pode selecionar `Crowdsourcing` no menu suspenso.
