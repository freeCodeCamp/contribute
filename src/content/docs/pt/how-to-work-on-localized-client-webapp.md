---
title: Como trabalhar na aplicação de client da web traduzida
---
...
Você pode aprender mais sobre configurar o client localmente para desenvolvimento seguindo [nosso guia de configuração aqui](how-to-setup-freecodecamp-locally). Por padrão, a aplicação está disponível somente em inglês.
...
:::tip
Você não precisa seguir esse documento para traduzir o currículo do freeCodeCamp ou contribuir com a documentação. Em vez disso, leia [esse guia aqui](how-to-translate-files).
:::
...
- O arquivo `intro.json` contém os pares chave-valor para o texto de introdução nas páginas de certificação.
  ...
  Se você deseja adicionar/atualizar traduções para as chaves, [leia este guia aqui](how-to-translate-files).
