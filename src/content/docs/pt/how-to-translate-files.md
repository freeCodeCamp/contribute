---
title: Como traduzir arquivos do freeCodeCamp
---
...
:::tip
Você pode começar lendo [este anúncio](https://www.freecodecamp.org/portuguese/news/como-ajudar-a-traduzir-o-freecodecamp-para-seu-idioma/). Recomendamos que entre [em nosso fórum da comunidade](https://forum.freecodecamp.org/c/contributors/3) e [no servidor de chat do Discord](https://discord.gg/PRyKn3Vbay).
:::
...
Esses arquivos provavelmente serão atualizados pelo líder do seu idioma, mas fique à vontade para [ler sobre como os traduzimos](language-lead-handbook).

### No Crowdin

:::danger
Não edite o seguintes arquivos por meio de um PR no GitHub.
:::
...
Você pode descobrir como o `docsify` converte uma string em seu idioma em um ID, analisando as páginas traduzidas. Se a tradução ainda não tiver sido implementada, você pode pré-visualizá-la [executando o site da documentação localmente](how-to-work-on-the-docs-theme#serving-the-documentation-site-locally).

Você pode aprender mais sobre [links internos em nossa documentação aqui](how-to-work-on-the-docs-theme#how-to-create-an-internal-link).
