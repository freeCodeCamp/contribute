...
Some email workflows require the back-end API server to send outgoing emails. [Mailpit](https://github.com/axllent/mailpit) is a developer tool for email testing that catches messages sent by the local API server instead of delivering them through a real email provider.
...
- **Certification**: Congratulations email when a user claims the Full Stack Developer v9 certification
