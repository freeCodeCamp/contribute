...
node.find_matches()[0].find_match_cases()[0].find_case_body().is_equivalent("print(0)\nprint('spam')") # True
node.find_matches()[0].find_match_cases()[1].find_case_body().is_equivalent("pass") # True
```
