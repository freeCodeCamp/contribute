...
To begin proofreading, visit [our translation platform](https://freecodecamp.crowdin.com/ and login. Select "Go to console" in the top navigation bar to switch from the public view to the workspace view.
