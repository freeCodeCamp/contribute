---
title: Як відкрити запит на злиття (PR)
---
...
> [!NOTE] Ваш PR повинен націлюватись лише на зміни навчальної програми англійською мовою. Див. [цей довідник](index#translations), щоб зробити внесок до перекладу.
...
5. Вкажіть, чи ви проводили тести на локальній копії сайту.
   ...
   - Якщо ваш PR впливає на поведінку сторінки, він повинен супроводжуватися відповідними [інтеграційними тестами Playwright](how-to-add-playwright-tests).
...
:::tip
Якщо ви хочете внести ще більше PR, ми рекомендуємо прочитати про [внесення змін та синхронізацію](how-to-setup-freecodecamp-locally#making-changes-locally), щоб уникнути видалення вашого розгалуження.
:::
