...
5. Do not "@mention" maintainers or reviewers on your pull request. It can come across as rude, and they are likely busy with many other requests.
   ...
   If you need help or have a question, use the support links provided in this contributing guide — the [`Contributors` category on our community forum](https://forum.freecodecamp.org/c/contributors) or the `#Contributors` channel on [our chat server](https://discord.gg/PRyKn3Vbay). We understand you are excited about contributing, but please be patient — someone will get to you sooner or later.
