...
3. When submitting a PR, put an x in each of the boxes like this: `[x]`. Make sure you follow the PR checklist and not just tick things off; otherwise, we won't take you seriously.
