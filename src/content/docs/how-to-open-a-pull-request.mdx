...
3. Follow the PR checklist and tick things off with an `X` when you have completed them; make sure you actually follow it and not just tick things off otherwise, we won't take you seriously.
