...
If you're using a GUI, you can simply `Add a new remote...` and use the link `https://github.com/freeCodeCamp/freeCodeCamp.git` from above.
...
We are closing this pull request because we do not add links to external resources to the curriculum.
