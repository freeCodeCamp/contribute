...
| App                 | Type        | Website active                                                                                                              |
| ------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------- |
| Learning platform   | Web         | `freecodecamp.org/learn`                                                                                                    |
| Publications        | Web         | `freecodecamp.org/news`, `freecodecamp.org/<language>/news`, etc.                                                           |
| freeCodeCamp Mobile | Mobile      | `https://play.google.com/store/apps/details?id=org.freecodecamp`, `https://apps.apple.com/us/app/freecodecamp/id1442777773` |
| DeveloperQuiz       | Web         | `developerquiz.org`                                                                                                         |
| LearnToCodeRPG      | Mobile      | `https://play.google.com/store/apps/details?id=org.freecodecamp.learntocoderpg`                                             |
| freeCodeCamp API    | API/Service | `api.freecodecamp.org`                                                                                                      |
| Socrates            | API/Service | `socrates.freecodecamp.org`                                                                                                 |
| Donations           | Web         | `donate.freecodecamp.org`                                                                                                   |
...
- Additionally, we may selectively accept reports for some freeCodeCamp GitHub repositories, which we use actively in production.
...
- AI-generated reports without manual verification.
...
**Email your report** to `possible-security-issue [at] freecodecamp.org`.
