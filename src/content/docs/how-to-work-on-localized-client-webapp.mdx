...
<Aside type='note' title='Interested in translating freeCodeCamp?'>

You do not need to follow this document to translate freeCodeCamp's curriculum or contributing documentation. Follow [this guide here](/how-to-translate-files/) instead.
...
- i18n
  ...
  - locales
    ...
    - .../
    - english
      - **intro.json** _Intro text on the certification pages_
      - links.json
      - meta-tags.json
      - motivation.json
      - **translations.json** _Text that appears on the UI elements_
    - espanol
      - intro.json
      - links.json
      - ...
