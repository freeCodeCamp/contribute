...
You should already have a fork of freeCodeCamp on GitHub. If not, [follow these instructions to fork the repository](https://www.freecodecamp.org/news/how-to-fork-a-github-repository/). Next, you will need to [clone](https://help.github.com/articles/cloning-a-repository/) your fork to your local machine.
