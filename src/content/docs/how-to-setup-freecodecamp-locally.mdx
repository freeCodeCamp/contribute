...
You should already have a fork of freeCodeCamp on GitHub. If not, [follow these instructions to fork the repository](/how-to-setup-freecodecamp-locally/#fork-the-repository-on-github). Next, you will need to [clone](https://help.github.com/articles/cloning-a-repository/) your fork to your local machine.
