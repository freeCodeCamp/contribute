...
4. Click **Create codespace on main**
   ...
   Your codespace will automatically set up the development environment using our custom devcontainer image. This includes:
...
**Option 1:** Press `Ctrl+Shift+P` (or `Cmd+Shift+P` on Mac), type "Run Task", and select **Start Development**.

**Option 2:** In the terminal, run:
