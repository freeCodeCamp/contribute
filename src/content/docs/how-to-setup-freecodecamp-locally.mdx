...
- The hardware requirements need to be better than [what we recommend](/how-to-setup-freecodecamp-locally/#how-to-prepare-your-local-machine) to accommodate for a WSL-based setup.
