...
- This project ONLY supports development on **macOS and Linux systems such as Ubuntu**.
- On Windows, you cannot use `Command Prompt`, `Git Bash`, or `PowerShell`. Instead, install [WSL2](/how-to-setup-wsl/) (Windows Subsystem for Linux) to create a Linux environment and then follow the Linux instructions.
- We recommend using [Windows Terminal](https://github.com/microsoft/terminal) to run your WSL2 environment for the best experience.
