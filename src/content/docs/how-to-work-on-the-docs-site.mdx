...
Before installing dependencies, ensure you are using the required Node.js version.
...
We recommend using a Node.js version manager such as [nvm](https://github.com/nvm-sh/nvm) to manage Node.js versions across projects.
...
Enable Corepack (recommended for newer Node.js versions):
