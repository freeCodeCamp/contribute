...
For more examples, you can look at the markdown files for the following video course. All the challenges already have questions: [Full Stack Development Course](https://github.com/freeCodeCamp/freeCodeCamp/blob/main/curriculum/challenges/english/25-front-end-development/lecture-working-with-arrays/67329f508a6ec45b046700b3.md)
