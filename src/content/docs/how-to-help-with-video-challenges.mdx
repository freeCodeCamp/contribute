...
For more examples, you can look at the markdown files for the following video course. All the challenges already have questions: [B1 English for Developers Course](https://github.com/freeCodeCamp/freeCodeCamp/blob/0d2268981ceee8accb81bf220dff4124598ccab1/curriculum/challenges/english/24-b1-english-for-developers/learn-how-to-use-modal-verbs/67d7fe955eef0f8200c1a719.md?plain=1#L3)
