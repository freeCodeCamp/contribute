...
:::note
Users who have been banned or muted can appeal their moderation actions. As a moderator, you can use `/unban` and `/unmute` commands when processing approved appeals. You can also use `/history` to review a user's moderation history.
:::
