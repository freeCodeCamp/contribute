...
Not at the moment. We're exploring new ways to translate freeCodeCamp's resources into world languages, so we're not accepting contributions to translate our curriculum for now.

In the meantime, consider contributing to [other areas](/getting-started/) that are open. If you have questions, reach out on our [Discord server](https://chat.freecodecamp.org).
...
- The `freeCodeCamp Community` category of [our community forum](https://forum.freecodecamp.org/c/site-community).
- The `#freecodecamp-community` channel on [our chat server](https://discord.gg/PRyKn3Vbay).
