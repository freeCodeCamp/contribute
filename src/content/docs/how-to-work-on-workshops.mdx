...
Write instructions in the second person, using American English and short, direct sentences. State what campers need to change and where. Name the relevant file, function, variable, or element, and put code identifiers in backticks. Explain new concepts before asking campers to apply them.
...
- Instruction: Inside `greet`, return the string `"Hello"`.
- Hint: Your `greet` function should return the string `"Hello"`.

Avoid vague hints such as "Your code is incorrect."

Follow the [challenge-description guidelines](/how-to-work-on-coding-challenges/#challenge-descriptionsinstructions), [challenge-text formatting rules](/how-to-work-on-coding-challenges/#formatting-challenge-text), and [Writing Style Guide](/writing-style-guide/) for wording, code references, and punctuation.
...
Follow the [seed-code formatting guidelines](/how-to-work-on-coding-challenges/#formatting-seed-code):
...
Use seed comments sparingly and follow the [seed-code comment rules](/how-to-work-on-coding-challenges/#seed-code-comments). Comments must match an entry in the comment dictionary, including its case and spacing.
