...
#### Pre-indent Editable Regions

When defining editable regions, ensure they are pre-indented to the correct level. This helps:

- Maintain consistent formatting.
- Prevent unnecessary syntax errors.
- Improve readability and campers experience.

#### Write Clear and Concise Instructions

Good challenge instructions should:

- Begin with a short conceptual explanation of the topic being taught.
- Clearly describe the goal of the challenge.
- Use simple, direct language appropriate for campers.
- Follow the conventions and writing style used throughout the existing curriculum.

#### Provide Helpful and Progressive Hints

Hints should:

- Start with high-level conceptual guidance.
- Progressively reference relevant syntax, methods, or patterns introduced earlier in the curriculum.
- Help campers understand why something works, not just what to write.
