...
Workshops should alternate between guided steps that introduce new concepts gradually and steps that give learners freedom in how they apply those concepts.
