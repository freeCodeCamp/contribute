...
1. [Challenge types](https://github.com/freeCodeCamp/freeCodeCamp/blob/main/shared/config/challenge-types.ts) - what the numeric challenge type values mean (enum).
