...
The core curriculum is broken down into workshops, labs, review pages and quizzes. Each of those components has its own tooling and processes.

To learn more, refer to these specialized guides:
