...
## Specialized Guides for the Curriculum

The workshops, labs and quizzes have additional tooling and processes. To learn more, refer to these guides:
...
### Adding new Challenge hints/solutions Topics (deprecated)
...
### Guidelines for Content of Hints and Solutions Topics (deprecated)
...
1. [Challenge types](https://github.com/freeCodeCamp/freeCodeCamp/blob/main/shared/config/challenge-types.ts#L1-#L28) - what the numeric challenge type values mean (enum).
