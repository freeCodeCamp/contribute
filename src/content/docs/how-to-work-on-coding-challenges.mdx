...
The workshops and labs have additional tooling and processes. To learn more, refer to these guides:
...
Transcript of the video, should only be used in video challenges.
