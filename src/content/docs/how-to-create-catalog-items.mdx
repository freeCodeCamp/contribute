...
:::note
In the chapter-mocule-block structure, modules are also a collection of blocks. As a result, existing modules could be easily referenced and re-arranged into a catalog item without the need to create new block and challenge files.
:::
