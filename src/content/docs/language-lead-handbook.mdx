...
To set up the auto-translation workflow for your language, you need to:
...
The minimum requirements to make the workflow work are as follows:
...
![Issue templage](../../../public/images/github/auto-translate-issue.png)
