...
Moderators can use Templates to insert pre-written responses developed with the mod team for common situations. In the reply composer, open the extras menu and select **Insert template**.

Read through the current [Templates category](https://forum.freecodecamp.org/c/templates/585) to become familiar with the available responses and when to use them. Ask fellow moderators if you are unsure which template fits a situation.
