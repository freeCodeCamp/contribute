...
The colors, fonts, and base styles are defined in the external [`@freecodecamp/ui`](https://github.com/freeCodeCamp/ui) component library. To contribute to this library, see our [component library contribution guide](/how-to-work-on-the-component-library/). This package provides:

- Color variables and design tokens
- Font definitions and typography
- Tailwind CSS utilities and base styles
- Reusable UI components

You can import components from `@freecodecamp/ui` in your React code, and the CSS is automatically included via the `base.css` file.
...
In most cases, our [linter](/how-to-setup-freecodecamp-locally/#additional-prerequisites) will warn of any formatting which goes against this codebase's preferred practice.
