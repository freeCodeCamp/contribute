...
You can create the review with `pnpm run create-new-project`. This opens a command line UI that guides you through the process. Once it finishes, it creates block metadata and a single review challenge in the English curriculum.
