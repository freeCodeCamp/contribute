...
You can create the review with `pnpm run create-new-project`. This opens a command line UI that guides you through the process. Once it finishes, it creates a new block.
