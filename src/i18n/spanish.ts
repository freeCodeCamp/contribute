export const translations = {
  ...
  'Work on translating resources': 'Trabajar en la traducción de recursos',
  'Work on proofreading translations': 'Revisar las traducciones',
  'Code Contribution': 'Participa en la programación',
  'Set up freeCodeCamp': 'Configuración de FreeCodeCamp',
  'Follow best-practices': 'Seguir las mejores prácticas de código',
  ...
  'Additional Guides': 'Guías adicionales',
  'Understand the curriculum file structure':
    'Entender la estructura de los archivos del currículo',
  'Debug outgoing emails locally': 'Depurar localmente los emails salientes',
  ...
  'Moderator Handbook': 'Manual del moderador',
  ...
  GitHub: 'GitHub',
  'Discourse Forum': 'Foro Discourse',
